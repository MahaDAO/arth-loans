...
[Home](./index.md) &gt; [@mahadao/arth-lib-ethers](./arth-lib-ethers.md) &gt; [PopulatedEthersRedemption](./arth-lib-ethers.populatedethersredemption.md) &gt; [increaseAmountByMinimumNetDebt](./arth-lib-ethers.populatedethersredemption.increaseamountbyminimumnetdebt.md)
...
|  --- | --- | --- |
|  maxRedemptionRate | [Decimalish](./arth-lib-base.decimalish.md) | Maximum acceptable [redemption rate](./arth-lib-base.fees.redemptionrate.md) to use in the new transaction. |
