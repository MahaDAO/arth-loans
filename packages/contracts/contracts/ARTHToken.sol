...
contract ARTHToken is CheckContract, TransferableOwnable, ILiquityLUSDToken {
    ...
    function _requireCallerIsBorrowerOperations() internal view {
        require(borrowerOperationAddresses[msg.sender], "ARTHToken: Caller is not BorrowerOperations");
    }
