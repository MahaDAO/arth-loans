...
const MockUniswapOracle = artifacts.require("./MockUniswapOracle.sol")
...
contract('PriceFeed', async accounts => {
  ...
  beforeEach(async () => {
    ...
    base = await ERC20Mock.new('Base', 'Base', owner, 1e4)
    quote = await ERC20Mock.new('Quote', 'Quote', owner, 1e4)

    mockUniswap = await MockUniswapOracle.new()
