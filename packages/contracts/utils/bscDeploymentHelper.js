...
class MainnetDeploymentHelper {
  ...
  async connectCoreContracts(ARTHContracts, token) {
    ...
    console.log("set addr in Sorted Troves.");
    ...
    console.log("set addr in TroveManager.");
    ...
    console.log("set addr in BorrowerOperations.");
    ...
    console.log("set addr in StabilityPool.");
    ...
    console.log("set addr in ActivePool.");
    ...
    console.log("set addr in DefaultPool.");
    ...
    console.log("set addr in CollSurplusPool.");
    ...
    console.log("set addr in HintHelpers.");
