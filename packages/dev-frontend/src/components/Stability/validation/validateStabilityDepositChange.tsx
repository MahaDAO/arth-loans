...
export const validateStabilityDepositChange = (
  ...
  if (change.withdrawLUSD && haveUndercollateralizedTroves) {
    return [
      undefined,
      <ErrorDescription>
        You're not allowed to withdraw ARTH from your Stability Deposit when there are
        undercollateralized Loans. Please liquidate those Loans or try again later.
      </ErrorDescription>
    ];
  }
