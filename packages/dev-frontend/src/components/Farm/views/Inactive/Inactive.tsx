...
export const Inactive: React.FC = () => {
  ...
  return (
    <Card>
      ...
      <Box sx={{ p: [2, 3] }}>
        <InfoMessage title="You aren't farming MAHA.">
          <Paragraph>You can farm MAHA by staking your Uniswap ETH/ARTH LP tokens.</Paragraph>

          <Paragraph sx={{ mt: 2 }}>
            You can obtain LP tokens by adding liquidity to the{" "}
            <Link href={uniLink(addresses["lusdToken"])} target="_blank">
              ETH/ARTH pool on Uniswap. <Icon name="external-link-alt" size="xs" />
            </Link>
          </Paragraph>
        </InfoMessage>
