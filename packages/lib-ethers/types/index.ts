...
interface ActivePoolCalls {
  AMO_ROLE(_overrides?: CallOverrides): Promise<string>;
...
interface ActivePoolTransactions {
  borrow(amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  ...
  repay(amount: BigNumberish, _overrides?: Overrides): Promise<void>;
  ...
  setAddresses(_borrowerOperationsAddress: string, _troveManagerAddress: string, _stabilityPoolAddress: string, _defaultPoolAddress: string, _collSurplusPoolAddress: string, _governance: string, _wethAddress: string, _overrides?: Overrides): Promise<void>;
}
...
export interface ActivePool
  ...
  readonly filters: {
    ...
    Borrow(from?: string | null, amount?: null): EventFilter;
    ...
    Repay(from?: string | null, amount?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "Borrow"): _TypedLogDescription<{ from: string; amount: BigNumber }>[];
  ...
  extractEvents(logs: Log[], name: "Repay"): _TypedLogDescription<{ from: string; amount: BigNumber }>[];
...
interface BorrowerOperationsCalls {
  ...
  incentivePool(_overrides?: CallOverrides): Promise<string>;
  isOwner(_overrides?: CallOverrides): Promise<boolean>;
...
interface BorrowerOperationsTransactions {
  ...
  setAddresses(_troveManagerAddress: string, _activePoolAddress: string, _defaultPoolAddress: string, _stabilityPoolAddress: string, _gasPoolAddress: string, _collSurplusPoolAddress: string, _sortedTrovesAddress: string, _lusdTokenAddress: string, _wethAddress: string, _governanceAddress: string, _incentivePool: string, _overrides?: Overrides): Promise<void>;
...
interface PriceFeedCalls {
  ...
  umbFCDKey(_overrides?: CallOverrides): Promise<string>;
  umbRegistry(_overrides?: CallOverrides): Promise<string>;
}
...
interface StabilityPoolTransactions {
  ...
  setAddresses(_borrowerOperationsAddress: string, _troveManagerAddress: string, _activePoolAddress: string, _lusdTokenAddress: string, _sortedTrovesAddress: string, _wethAddress: string, _governanceAddress: string, _overrides?: Overrides): Promise<void>;
...
interface TroveManagerTransactions {
  ...
  setAddresses(_borrowerOperationsAddress: string, _activePoolAddress: string, _defaultPoolAddress: string, _stabilityPoolAddress: string, _gasPoolAddress: string, _collSurplusPoolAddress: string, _lusdTokenAddress: string, _sortedTrovesAddress: string, _governanceAddress: string, _wethAddress: string, _overrides?: Overrides): Promise<void>;
