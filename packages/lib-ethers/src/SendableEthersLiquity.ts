...
/**
 * Ethers-based implementation of {@link @mahadao/arth-lib-base#SendableLiquity}.
 *
 * @public
 */
  ...
  implements SendableLiquity<EthersTransactionReceipt, EthersTransactionResponse>
{
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.openTrove} */
  openTrove(
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.closeTrove} */
  closeTrove(
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.adjustTrove} */
  adjustTrove(
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.depositCollateral} */
  depositCollateral(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersLiquityTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.withdrawCollateral} */
  withdrawCollateral(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersLiquityTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.borrowLUSD} */
  borrowLUSD(
    amount: Decimalish,
    maxBorrowingRate?: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.repayLUSD} */
  repayLUSD(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersLiquityTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.liquidate} */
  liquidate(
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.liquidateUpTo} */
  liquidateUpTo(
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.depositLUSDInStabilityPool} */
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.withdrawLUSDFromStabilityPool} */
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.withdrawGainsFromStabilityPool} */
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.transferCollateralGainToTrove} */
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.sendLUSD} */
  sendLUSD(
    toAddress: string,
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.sendLQTY} */
  sendLQTY(
    toAddress: string,
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.redeemLUSD} */
  redeemLUSD(
    amount: Decimalish,
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.claimCollateralSurplus} */
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.stakeLQTY} */
  stakeLQTY(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersLiquityTransaction<void>> {
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.unstakeLQTY} */
  unstakeLQTY(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersLiquityTransaction<void>> {
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.withdrawGainsFromStaking} */
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.registerFrontend} */
  registerFrontend(
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.approveUniTokens} */
  approveUniTokens(
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.stakeUniTokens} */
  stakeUniTokens(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersLiquityTransaction<void>> {
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.unstakeUniTokens} */
  unstakeUniTokens(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersLiquityTransaction<void>> {
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.withdrawLQTYRewardFromLiquidityMining} */
  ...
  /** {@inheritDoc @mahadao/arth-lib-base#SendableLiquity.exitLiquidityMining} */
  exitLiquidityMining(
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersLiquityTransaction<void>> {
