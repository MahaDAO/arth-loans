...
export interface EthersLiquityConnectionOptionalParams {
  ...
  /**
   * Create a {@link @mahadao/arth-lib-base#LiquityStore} and expose it as the `store` property.
   *
   * @remarks
   ...
   * {@link @mahadao/arth-lib-base#LiquityStore.start | start()} function is called.
   */
