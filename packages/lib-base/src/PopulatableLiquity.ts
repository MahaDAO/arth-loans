 ...
 *
 * @remarks
 * Implemented by {@link @mahadao/arth-lib-ethers#PopulatedEthersLiquityTransaction}.
 *
 * @public
 */
...
> {
   ...
   *
   * @returns An object that implements {@link @mahadao/arth-lib-base#SentLiquityTransaction}.
   */
  send(): Promise<T>;
}
 ...
 * {@link @mahadao/arth-lib-base#LUSD_MINIMUM_DEBT | minimum debt} requirement that Troves must fulfill,
 * some LUSD amounts are not possible to redeem exactly.
 *
 * When {@link @mahadao/arth-lib-base#PopulatableLiquity.redeemLUSD | redeemLUSD()} is called with an
 ...
 * {@link @mahadao/arth-lib-base#PopulatedRedemption.increaseAmountByMinimumNetDebt | increasing the amount}
 * to the next lowest possible value, which is the sum of the truncated amount and
 * {@link @mahadao/arth-lib-base#LUSD_MINIMUM_NET_DEBT}.
 *
 * @public
 */
export interface PopulatedRedemption<P = unknown, S = unknown, R = unknown>
   ...
   *                            {@link @mahadao/arth-lib-base#Fees.redemptionRate | redemption rate} to
 ...
 *
 * Implemented by {@link @mahadao/arth-lib-ethers#PopulatableEthersLiquity}.
 *
 * @public
 */
