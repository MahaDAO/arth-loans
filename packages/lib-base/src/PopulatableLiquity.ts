 ...
 *
 * @remarks
 * Implemented by {@link @arthloans/lib-ethers#PopulatedEthersLiquityTransaction}.
 *
 * @public
 */
...
> {
   ...
   *
   * @returns An object that implements {@link @arthloans/lib-base#SentLiquityTransaction}.
   */
  send(): Promise<T>;
}
 ...
 * {@link @arthloans/lib-base#LUSD_MINIMUM_DEBT | minimum debt} requirement that Troves must fulfill,
 * some LUSD amounts are not possible to redeem exactly.
 *
 * When {@link @arthloans/lib-base#PopulatableLiquity.redeemLUSD | redeemLUSD()} is called with an
 ...
 * {@link @arthloans/lib-base#PopulatedRedemption.increaseAmountByMinimumNetDebt | increasing the amount}
 * to the next lowest possible value, which is the sum of the truncated amount and
 * {@link @arthloans/lib-base#LUSD_MINIMUM_NET_DEBT}.
 *
 * @public
 */
export interface PopulatedRedemption<P = unknown, S = unknown, R = unknown>
   ...
   *                            {@link @arthloans/lib-base#Fees.redemptionRate | redemption rate} to
 ...
 *
 * Implemented by {@link @arthloans/lib-ethers#PopulatableEthersLiquity}.
 *
 * @public
 */
