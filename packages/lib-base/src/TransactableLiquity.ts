 ...
 *
 * Implemented by {@link @arthloans/lib-ethers#EthersLiquity}.
 *
 * @public
 */
export interface TransactableLiquity {
   ...
   *                           {@link @arthloans/lib-base#Fees.borrowingRate | borrowing rate}.
   *
   * @throws
   ...
   * @param maxBorrowingRate - Maximum acceptable
   *                           {@link @arthloans/lib-base#Fees.borrowingRate | borrowing rate} if
   ...
   * {@link @arthloans/lib-base#LUSD_MINIMUM_DEBT}.
   *
   * If `maxBorrowingRate` is omitted, the current borrowing rate plus 0.5% is used as maximum
   * acceptable rate.
   */
   ...
   * {@link @arthloans/lib-base#StabilityDeposit.collateralGain | collateral gain} and
   * {@link @arthloans/lib-base#StabilityDeposit.lqtyReward | LQTY reward}.
   */
  ...
  /**
   * Withdraw {@link @arthloans/lib-base#StabilityDeposit.collateralGain | collateral gain} and
   * {@link @arthloans/lib-base#StabilityDeposit.lqtyReward | LQTY reward} from Stability Deposit.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
  ...
  /**
   * Transfer {@link @arthloans/lib-base#StabilityDeposit.collateralGain | collateral gain} from
   ...
   *                            {@link @arthloans/lib-base#Fees.redemptionRate | redemption rate}.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   *
   ...
   *
   * @remarks
   * Use {@link @arthloans/lib-base#ReadableLiquity.getCollateralSurplusBalance | getCollateralSurplusBalance()}
   ...
   * {@link @arthloans/lib-base#LQTYStake.collateralGain | collateral gain} and
   * {@link @arthloans/lib-base#LQTYStake.lusdGain | LUSD gain}.
   */
  ...
  /**
   * Withdraw {@link @arthloans/lib-base#LQTYStake.collateralGain | collateral gain} and
   * {@link @arthloans/lib-base#LQTYStake.lusdGain | LUSD gain} from LQTY stake.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
   ...
   * {@link @arthloans/lib-base#TransactableLiquity.stakeUniTokens | staking}.
   *
   ...
   * {@link @arthloans/lib-base#TransactableLiquity.stakeUniTokens | stakeUniTokens()}.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
