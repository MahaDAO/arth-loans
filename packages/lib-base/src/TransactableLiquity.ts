 ...
 *
 * Implemented by {@link @mahadao/arth-lib-ethers#EthersLiquity}.
 *
 * @public
 */
export interface TransactableLiquity {
   ...
   *                           {@link @mahadao/arth-lib-base#Fees.borrowingRate | borrowing rate}.
   *
   * @throws
   ...
   * @param maxBorrowingRate - Maximum acceptable
   *                           {@link @mahadao/arth-lib-base#Fees.borrowingRate | borrowing rate} if
   ...
   * {@link @mahadao/arth-lib-base#LUSD_MINIMUM_DEBT}.
   *
   * If `maxBorrowingRate` is omitted, the current borrowing rate plus 0.5% is used as maximum
   * acceptable rate.
   */
   ...
   * {@link @mahadao/arth-lib-base#StabilityDeposit.collateralGain | collateral gain} and
   * {@link @mahadao/arth-lib-base#StabilityDeposit.lqtyReward | LQTY reward}.
   */
  ...
  /**
   * Withdraw {@link @mahadao/arth-lib-base#StabilityDeposit.collateralGain | collateral gain} and
   * {@link @mahadao/arth-lib-base#StabilityDeposit.lqtyReward | LQTY reward} from Stability Deposit.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
  ...
  /**
   * Transfer {@link @mahadao/arth-lib-base#StabilityDeposit.collateralGain | collateral gain} from
   ...
   *                            {@link @mahadao/arth-lib-base#Fees.redemptionRate | redemption rate}.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   *
   ...
   *
   * @remarks
   * Use {@link @mahadao/arth-lib-base#ReadableLiquity.getCollateralSurplusBalance | getCollateralSurplusBalance()}
