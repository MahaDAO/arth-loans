...
export interface ReadableLiquity {
   ...
   *
   * @remarks
   * Needed when dealing with instances of {@link @mahadao/arth-lib-base#TroveWithPendingRedistribution}.
   */
   ...
   * {@link @mahadao/arth-lib-base#ReadableLiquity.getTrove | getTrove()}.
   */
   ...
   * {@link @mahadao/arth-lib-base#TransactableLiquity.claimCollateralSurplus | claimCollateralSurplus()}.
   */
