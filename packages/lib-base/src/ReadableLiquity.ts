...
export interface ReadableLiquity {
   ...
   *
   * @remarks
   * Needed when dealing with instances of {@link @arthloans/lib-base#TroveWithPendingRedistribution}.
   */
   ...
   * {@link @arthloans/lib-base#ReadableLiquity.getTrove | getTrove()}.
   */
   ...
   * {@link @arthloans/lib-base#TransactableLiquity.claimCollateralSurplus | claimCollateralSurplus()}.
   */
