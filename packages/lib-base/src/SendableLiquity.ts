 ...
 *
 * @remarks
 * Implemented by {@link @mahadao/arth-lib-ethers#SentEthersLiquityTransaction}.
 *
 * @public
 */
export interface SentLiquityTransaction<S = unknown, T extends LiquityReceipt = LiquityReceipt> {
   ...
   *
   * @remarks
   * Unlike {@link @mahadao/arth-lib-base#SentLiquityTransaction.waitForReceipt | waitForReceipt()},
   ...
   *
   * @returns Either a {@link @mahadao/arth-lib-base#FailedReceipt} or a
   *          {@link @mahadao/arth-lib-base#SuccessfulReceipt}.
   */
 ...
 *
 * Implemented by {@link @mahadao/arth-lib-ethers#SendableEthersLiquity}.
 *
 * @public
 */
