 ...
 *
 * @remarks
 * Implemented by {@link @arthloans/lib-ethers#SentEthersLiquityTransaction}.
 *
 * @public
 */
export interface SentLiquityTransaction<S = unknown, T extends LiquityReceipt = LiquityReceipt> {
   ...
   *
   * @remarks
   * Unlike {@link @arthloans/lib-base#SentLiquityTransaction.waitForReceipt | waitForReceipt()},
   ...
   *
   * @returns Either a {@link @arthloans/lib-base#FailedReceipt} or a
   *          {@link @arthloans/lib-base#SuccessfulReceipt}.
   */
 ...
 *
 * Implemented by {@link @arthloans/lib-ethers#SendableEthersLiquity}.
 *
 * @public
 */
